...
def build_apache_php_images():
    ...
    for i in range(int((plen*2)/6),int((plen*3)/6)):
        ...
        build_command = "docker build -f {dockerfile_path} -t {repo_owner}/{image_name}:v{image_version} {build_context_path}".format(
